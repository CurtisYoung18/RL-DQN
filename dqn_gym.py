...
# Initialize lists to store rewards and R100 values
all_rewards = []
r100_list = []
epsilon_list = []
...
while True:
    ...
    if is_done:
        ...
        # Calculate R100 if enough episodes have been completed
        ...
        if len(all_rewards) > 10 and len(losses) > 10:
            ...
            # Plotting the R100 vs Episode Reward every 100 episodes
            if episode_no % 100 == 0:
